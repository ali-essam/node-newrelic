...
function getActiveSegment(obj) {
  ...
  if (segment && segment.transaction) {
    if (typeof segment.transaction.isActive === 'function') {
      ...
      console.log('NEWRELICDEBUG segment', stringify(segment))
      console.log('NEWRELICDEBUG segment.transaction', stringify(segment.transaction))
      console.log('NEWRELICDEBUG segment.transaction.isActive', stringify(segment.transaction.isActive))
      console.log('NEWRELICDEBUG typeof segment.transaction.isActive', stringify(typeof segment.transaction.isActive))
      return null
    }
  }
  return null
